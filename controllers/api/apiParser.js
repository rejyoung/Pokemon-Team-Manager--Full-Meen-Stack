            ...
            if (firstEvolution["evolution_details"][0]) {
                if (
                    ...
                    if (
                        ...
                        typeof firstEvolution["evolution_details"][0][
                            "min_level"
                        ] != "undefined"
                    ) {
                        minLev =
                    ...
                    finalLevel.forEach((finalEvolution) => {
                        ...
                        if (finalEvolution["evolution_details"][0]) {
                            if (
                                ...
                                typeof finalEvolution["evolution_details"] !=
                                    "undefined" &&
                                typeof finalEvolution["evolution_details"][0] !=
                                    "undefined"
                            ) {
                                if (
                                    finalEvolution["evolution_details"][0][
                                        "min_level"
                                    ] &&
                                    typeof finalEvolution[
                                        "evolution_details"
                                    ][0]["min_level"] != "undefined"
                                ) {
                                    finMinLev =
                                        finalEvolution["evolution_details"][0][
                                            "min_level"
